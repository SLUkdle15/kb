...
Send the money to mom via a bank transfer to her account.
...
- Threshold unit for the fee question ("16") is unclear from the original capture — clarify with the bank on the call.
