...
- Log a task here the moment it is used, with which book and test it came from.
- **Reserve at least two full unseen tests** for the plan's two mock checkpoints. A mock sat on familiar material measures nothing.
- Reading and Listening sections count too, not just Writing.
...
Come back to this note when the test is booked, and again before the first mock checkpoint, to confirm enough unseen tests are still in reserve.
