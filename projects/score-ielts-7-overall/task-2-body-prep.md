...
3. *In Hanoi, a single street in Cầu Giấy can hold a dozen fast-food counters and not one shop selling fresh vegetables after seven in the evening.* (26)
4. *Knowing that such food is harmful changes little when it is both the cheapest and the nearest option.* (18)

82 words. Sentence 4 does double duty: it answers the part of the prompt that is easiest to walk past — *even though they know it's bad for them* — and it hands body 2 its premise, since if knowledge is not the constraint then information campaigns are not the remedy.
