...
| --- | --- | --- |
| a belief | opinion, discuss both views | **T1 — attribute it** |
| a situation | problem and solution, advantages and disadvantages, two-part question | **T2 — just state it** |
...
- **09-03, opinion** — *It is often argued that written examinations fail to capture what a student actually understands, and that other forms of assessment would serve better.*
- **09-07, discuss both views** — *Some people argue that children should be encouraged to compete, while others believe that those taught to co-operate grow into more useful adults.*
- **09-05, problem and solution** — *Many schools devote far more classroom time to transmitting facts than to the judgment and social skills students need after they leave.*
- **09-05, advantages and disadvantages** — *A growing number of schools now assess students through projects and presentations rather than written examinations.*
- **two-part question** — *An increasing number of people now work for themselves rather than taking a job with a company.*
...
| --- | --- | --- | --- |
| 09-03 | Opinion | *There is a school of thought a written exam is not the best way to assess a student's ability.* | Yes |
| 09-05 | Problem/Solution | *There is a school of thought that schools mainly teach students facts and hardly spend time to teach social skills and thinking abilities.* | Yes |
...
- [ ] The intro introduces no idea the bodies will not argue.
- [ ] *that* is present after *a school of thought*, *the argument*, and *I agree* — the pattern with the most entries in [[projects/score-ielts-7-overall/error-log|Error Log]].
