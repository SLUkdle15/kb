...
- [[next/next-actions/2026-09-18 - List What Is Left for Chatbot Excel Support|List What Is Left for Chatbot Excel Support]]
...
That list came from the architecture note, not from a survey of the code. The first next action is to check it against what is actually built and fill the gaps.
